    ...
    >
      ...
      >
        <el-form-item label="服务代码:" prop="userEleCode" class="labelitem">
          <el-input
            clearable
            v-model.trim="handleObj.userEleCode"
            placeholder="请输入服务代码名称"
          />
        </el-form-item>
        <el-form-item label="字段编码:" prop="dbEleCode" class="labelitem">
          <el-input
            clearable
            v-model.trim="handleObj.dbEleCode"
            placeholder="请输入字段编码"
          />
        </el-form-item>
        <el-form-item label="要素名称:" prop="eleName" class="labelitem">
          <el-input
            clearable
            v-model.trim="handleObj.eleName"
            placeholder="请输入要素中文名称"
          />
        </el-form-item>
        <el-form-item label="单位名称:" prop="eleUnit" class="labelitem">
          <el-input
            clearable
            v-model.trim="handleObj.eleUnit"
            placeholder="请输入单位名称"
          />
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            clearable
            v-model.trim="handleObj.isCodeParam"
            placeholder="请输入是否标识代码"
          />
        </el-form-item>
        <el-form-item label="标识代码表:" prop="codeTableId" class="labelitem">
          <el-input
            clearable
            v-model.trim="handleObj.codeTableId"
            placeholder="请输入标识代码表"
          />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="trueReportRecord('ruleForm')"
          >确 定</el-button
        >

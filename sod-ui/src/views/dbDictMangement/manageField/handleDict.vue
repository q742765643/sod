  ...
  <section class="fileHandleDict">
    ...
    >
      <el-form-item label="字段编码:" prop="dbEleCode">
        <el-input
          clearable
          v-model.trim="ruleForm.dbEleCode"
          placeholder="请输入字段编码"
        ></el-input>
      </el-form-item>
      <el-form-item label="服务代码:" prop="userEleCode">
        <el-input
          clearable
          v-model.trim="ruleForm.userEleCode"
          placeholder="请输入服务代码"
        ></el-input>
      </el-form-item>
      <el-form-item label="中文名:" prop="dbEleName">
        <el-input clearable v-model.trim="ruleForm.dbEleName"></el-input>
      </el-form-item>
      <el-form-item label="字段类型:" prop="type">
        <el-select clearable v-model.trim="ruleForm.type">
          <el-option
      ...
      <el-form-item label="组名称:" prop="groupId">
        <el-select clearable v-model.trim="ruleForm.groupId">
          <el-option
      ...
      <el-form-item label="字段精度:">
        <el-input clearable v-model.trim="ruleForm.dataPrecision"></el-input>
      </el-form-item>
      <el-form-item label="是否可为空:" prop="nullAble">
        <el-select clearable v-model.trim="ruleForm.nullAble">
          <el-option label="是" value="true"></el-option>
          <el-option label="否" value="false"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="是否可更新:" prop="updateAble">
        <el-select clearable v-model.trim="ruleForm.updateAble">
          <el-option label="是" value="true"></el-option>
          <el-option label="否" value="false"></el-option>
        </el-select>
      </el-form-item>

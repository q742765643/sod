<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" class="searchBox">
      <el-form-item prop="algName" label="算法分类:">
        <el-input clearable size="small" v-model="queryParams.algName" placeholder="请输入分类名称" />
      </el-form-item>
...
<script>
import { queryDataPage, delById } from "@/api/portalMangement/algMangement";
import handleAlg from "@/views/portalMangement/algMangement/handleAlg";

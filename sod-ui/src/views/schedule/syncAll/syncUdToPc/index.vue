...
export default {
  ...
  methods: {
    ...
    getListLog() {
      ...
      this.loading = true;
      listSyncudtopcLog(this.addDateRange(this.queryParamsLog, this.dateRange)).then(
        response => {
    ...
    handleUpdateLog(row) {
      ...
      getSyncudtopcLog(id).then(response => {
    ...
    getList() {
      ...
      this.loading = true;
      listSyncudtopc(this.addDateRange(this.queryParams, this.dateRange)).then(
        response => {

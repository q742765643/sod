<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableData" row-key="id">
        ...
        <el-table-column align="center" prop="examine_status" label="审核状态" min-width="60" v-if="datacell !==2 ">
        ...
        <el-table-column align="center" prop="EXAMINE_STATUS" label="操作" min-width="50" v-if="datacell!==5">

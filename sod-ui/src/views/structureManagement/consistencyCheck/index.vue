<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
         <el-button size="small"  v-hasPermi="['consistencyCheck:role:creat']" type="primary" icon="el-icon-document" @click="progressDownLoad()">生成差异报告</el-button>
      </el-col>
       <el-col :span="1.5">
         <el-button size="small"  v-hasPermi="['consistencyCheck:role:add']" type="primary" icon="el-icon-plus" @click="addReportData()">添加</el-button>
      </el-col>
       <el-col :span="1.5">
         <el-button size="small"  v-hasPermi="['consistencyCheck:role:delete']"  type="danger" icon="el-icon-delete" @click="deleteData()">删除</el-button>
      </el-col>
    </el-row>

    <el-table v-loading="loading" :data="tableData" row-key="id"  @current-change="handleCurrentChange">
        ...
        <el-table-column align="center" prop="database_instance" label="专题库实例" sortable min-width="100"></el-table-column>
        <el-table-column align="center" prop="database_schema_name" label="专题名ID" sortable min-width="100"></el-table-column>
    ...
    <pagination
      ...
      @pagination="getList"
    />
     <el-dialog title="添加" :visible.sync="addDataDialog" width="40%">
      <el-form>
    ...
    <el-dialog title="历史报告表" :visible.sync="historyDialog" width="80%" height="50%">
      <el-table ref="singleTable" :data="historyData" highlight-current-row border stripe>
        <el-table-column align="center" type="index" min-width="20" label=" " :index="table_index_history"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    table_index_history(index){
      return (this.historyObj.pageNum - 1) * this.historyObj.pageSize + index + 1;
    },
    /** 搜索按钮操作 */
    handleQuery() {

        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="空间分辨率" prop="spatialResolution">
              <el-input
                v-model.trim="baseSet.spatialResolution"
                size="small"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="层次类型转换因子" prop="scaleDivisor">
              <el-input
                placeholder="层次类型转换因子"
                v-model.trim="msgFormDialog.scaleDivisor"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="资料时次" prop="eleHours">
              <el-input
                placeholder="资料时次"
                v-model.trim="msgFormDialog.eleHours"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="空间分辨率" prop="gridPixel">
              <el-input
                placeholder="空间分辨率"
                v-model.trim="msgFormDialog.gridPixel"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="预报时效单位" prop="timeUnit">
              <el-input
                placeholder="预报时效单位"
                v-model.trim="msgFormDialog.timeUnit"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="层次单位" prop="levelUnit">
              <el-input
                placeholder="层次单位"
                v-model.trim="msgFormDialog.levelUnit"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="24">
            <el-form-item label="层次列表" prop="levelList">
              <el-input
                type="textarea"
                placeholder="层次列表"
                v-model.trim="msgFormDialog.levelList"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="24">
            <el-form-item label="预报时效列表" prop="timeList">
              <el-input
                type="textarea"
                placeholder="预报时效列表"
                v-model.trim="msgFormDialog.timeList"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>

...
<script>
/*字段管理*/
import ColumnManage from "@/views/structureManagement/dataList/TableManage/ColumnManage";
/*索引*/
import indexManage from "@/views/structureManagement/dataList/TableManage/IndexManage";
/*分库分表键*/
import partKeyManage from "@/views/structureManagement/dataList/TableManage/PartKeyManage";
/*资料类型统计*/
import DataStatistics from "@/views/structureManagement/dataList/TableManage/DataStatistics";
/*样例数据查询*/
import SampleData from "@/views/structureManagement/dataList/TableManage/SampleData";
/*表信息*/

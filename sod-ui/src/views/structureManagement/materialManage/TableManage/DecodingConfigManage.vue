<template>
  <el-main>
    ...
    <el-table
      ...
      :data="tableData"
      stripe
      @selection-change="(res) => (selData = res)"
    >
      <el-table-column
        type="index"
        label="序号"
    ...
    >
      <div>
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" size="small" @click="searchOptConfig(1)"
              >查询</el-button
            >
          </el-form-item>
        </el-form>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="trueHandle('table')" size="small"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
          ...
          <el-col :span="12">
            <el-form-item label="处理编码" prop="dataDpcId">
              <el-input
                size="small"
                placeholder="处理编码"
                v-model.trim="formData.dataDpcId"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="格点要素短名" prop="eleCodeShort">
              <el-input
                size="small"
                placeholder="格点要素短名"
                v-model.trim="formData.eleCodeShort"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="参数ID" prop="parameterId">
              <el-input
                size="small"
                placeholder="参数ID"
                v-model.trim="formData.parameterId"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="模板编号" prop="templateId">
              <el-input
                size="small"
                placeholder="模板编号"
                v-model.trim="formData.templateId"
              ></el-input>
            </el-form-item>
          </el-col>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="trueHandle('formData')"
          >确 定</el-button
        >
...
import {
  ...
  saveList,
  deleteList,
} from "@/api/structureManagement/materialManage/DecodingConfigManage";

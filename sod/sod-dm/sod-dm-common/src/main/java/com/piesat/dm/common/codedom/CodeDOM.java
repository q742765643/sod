package com.piesat.dm.common.codedom;
...
public class CodeDOM {
    ...
    private CodeDOM(String tableName) {
        ...
        basePackage_ = "com\\piesat\\dm\\common\\codedom\\";
        ...
        basePath = System.getProperty("user.dir") + "\\sod\\sod-dm\\sod-dm-common\\src\\main\\java\\" + package_;
    }
    ...
    public static List<Map> getList(String sql) {
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public static void main(String[] args) {
        List<Map> list = getList("select * from DMIN_DB_PHYSICS_DEFINE");
        for (Map m:list ) {
            System.out.println(m.get("DATABASE_ID"));
            System.out.println(m.get("DATABASE_NAME"));
            System.out.println(m.get("SERIAL_NUMBER"));
            System.out.println(m.get("DATABASE_INSTANCE"));
            System.out.println(m.get("DATABASE_TYPE"));

...
import com.xugu.fetl.permission.LoadPermission;
...
//					String outinfo = "CREATE TABLE " + otab + "(\r\n";
	...
	public String expData(String fileName,String tableName,String sql,String url) throws SQLException{
		StringBuffer returnString = new StringBuffer();
		sql += " limit 1";
		Connection conn = null;
		Statement st = null;
